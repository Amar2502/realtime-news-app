...
import { Clock, TrendingUp, ChevronRight, Cpu, Star, ArrowLeft, Sparkles, Activity, Zap } from "lucide-react";
            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <p className="text-xl text-gray-600 max-w-2xl leading-relaxed">
                  Discover the latest in technology, innovation breakthroughs, startup launches, and cutting-edge developments from Silicon Valley and beyond.
                </p>
              </div>
              {!isLoading && (
          ...
          <div className="flex justify-center my-16">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="text-center">
                <p className="text-lg font-medium text-gray-700">Loading tech news...</p>
                <p className="text-sm text-gray-500">Getting the latest innovation updates</p>
              </div>
            </div>
          </div>
        ) : (
            ...
            {news.length === 0 ? (
              <div className="flex justify-center my-16">
                <div className="text-center p-12 bg-white/60 backdrop-blur-sm rounded-3xl border border-white/20 shadow-lg max-w-md">
                  <div className="p-4 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-2xl w-fit mx-auto mb-6">
                    <Zap className="w-12 h-12 text-blue-400" />
                  </div>
                  <h3 className="text-xl font-semibold text-gray-700 mb-2">No Tech News Available</h3>
                  <p className="text-gray-500">Check back soon for the latest technology and innovation updates</p>
                </div>
              </div>
            ) : (
              /* News Grid */
                  ...
                  >
                    ...
                    <div className="relative p-6 flex flex-col flex-grow">
                      <div className="flex items-center justify-between mb-4">
                        <span className="px-3 py-1.5 text-xs font-bold rounded-full shadow-sm bg-gradient-to-r from-blue-100 to-indigo-200 text-blue-800">
                          {item.category}
                        </span>
                        
                        {item.trending && (
                          <div className="flex items-center gap-1 px-2 py-1 bg-gradient-to-r from-yellow-100 to-blue-100 text-blue-700 text-xs font-medium rounded-full">
