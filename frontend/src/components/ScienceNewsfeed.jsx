...
import { Clock, TrendingUp, ChevronRight, Atom, Star, ArrowLeft, Sparkles, Activity, Microscope } from "lucide-react";
          ...
          <div className="relative p-8 rounded-3xl backdrop-blur-sm bg-white/40 border border-white/20 shadow-lg">
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <h1 className="text-5xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-cyan-800 bg-clip-text text-transparent mb-3">
                  Science News
                </h1>
                <p className="text-xl text-gray-600 max-w-2xl leading-relaxed">
                  Discover groundbreaking research, scientific breakthroughs, and innovations that are shaping our understanding of the world.
                </p>
              </div>
              {!isLoading && (
          ...
          <div className="flex justify-center my-16">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="text-center">
                <p className="text-lg font-medium text-gray-700">Loading science news...</p>
                <p className="text-sm text-gray-500">Getting the latest research updates</p>
              </div>
            </div>
          </div>
        ) : (
            ...
            {news.length === 0 ? (
              <div className="flex justify-center my-16">
                <div className="text-center p-12 bg-white/60 backdrop-blur-sm rounded-3xl border border-white/20 shadow-lg max-w-md">
                  ...
                  <h3 className="text-xl font-semibold text-gray-700 mb-2">No Science News Available</h3>
                  <p className="text-gray-500">Check back soon for the latest scientific discoveries and research updates</p>
                </div>
              </div>
            ) : (
              /* News Grid */
                  ...
                  >
                    ...
                    <div className="relative p-6 flex flex-col flex-grow">
                      <div className="flex items-center justify-between mb-4">
                        <span className="px-3 py-1.5 text-xs font-bold rounded-full shadow-sm bg-gradient-to-r from-cyan-100 to-blue-200 text-cyan-800">
                          {item.category}
                        </span>
